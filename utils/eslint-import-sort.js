...
/**
 * @typedef {Object} SimpleImportSortParams
 * @property {String[] | String[][]} sortOrder - the order of any internal imports
 ...
 *
 * @param {SimpleImportSortParams} params
 *
 * @returns {Object}
 */
const simpleImportSortOptions = ({
    ...
    const pipedInternalAbsoluteImports = sortOrder.flat().join('|');
